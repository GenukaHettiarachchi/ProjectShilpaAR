...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-UvDjCw3p.js");
...
var ROUTER_BASEPATH = "ProjectShilpaAR";
var SERVER_FN_BASE = "/ProjectShilpaAR/_serverFn/";
